...
| **3 — TradeW Assistant (nav + voice)** | Intent classifier, navigation command grammar (`TRADEW-ASSISTANT.md`), voice input — layered onto the *existing* TradeW AI ambient copilot, not a rebuild | Phase 1 |
