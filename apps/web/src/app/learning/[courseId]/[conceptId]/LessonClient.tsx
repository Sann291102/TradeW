...
import { learningApi, lessonIdOf } from '@/lib/learning/api';
import type { Flashcard, Lesson, Quiz, TeacherAnswer } from '@/lib/learning/types';
 ...
 * from the API; nothing is authored here. Design language matches the rest of
 * the workspace (cards, teal accents, muted body text).
 */
