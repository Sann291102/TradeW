...
export function SentinelLiveCharts({
  ...
  return (
    <section className="rounded-2xl border border-border bg-card p-4 shadow-elev3 sm:p-5">
      <div className="mb-3">
        <p className="text-xs font-semibold uppercase tracking-wide text-faint">Live Charts</p>
