 ...
 */
export function OrderTicketPanel({ className, actions, collapsed }: DockPanelContentProps) {
  const [side, setSide] = useState<'BUY' | 'SELL'>('BUY');
  return (
    <Panel title="Order Ticket" className={className} scroll={false} actions={actions} collapsed={collapsed}>
