 ...
 *
 * Bare routes (the landing page's auth panel, /checkout, /reset) sit under this
 * provider too, so signing in on `/` and landing on `/dashboard` does not cross
 * a cache boundary and re-fetch what the auth flow already loaded.
 */
